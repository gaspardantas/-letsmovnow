...
const styles: Record<string, React.CSSProperties> = {
  ...
  offMarketBanner:{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(255,107,107,0.9)', color: '#fff', textAlign: 'center', padding: '12px', fontFamily: "'Syne', sans-serif", fontWeight: 600 },
  pendingBanner:  { position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(255,230,109,0.9)', color: '#1B1F3B', textAlign: 'center', padding: '12px', fontFamily: "'Syne', sans-serif", fontWeight: 600 },
  ...
  price:          { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 32, color: '#4ECDC4' },
  statusPill:     { fontSize: 12, fontWeight: 700, padding: '4px 12px', borderRadius: 20, fontFamily: "'Syne', sans-serif" },
  title:          { fontSize: 24, fontFamily: "'Syne', sans-serif", fontWeight: 700, marginBottom: 8 },
  ...
  tagVal:         { fontSize: 15, fontWeight: 600, color: '#F0F2FF', fontFamily: "'Syne', sans-serif" },
  sectionTitle:   { fontFamily: "'Syne', sans-serif", fontSize: 18, marginBottom: 12 },
  ...
  avatar:         { width: 44, height: 44, borderRadius: '50%', background: 'linear-gradient(135deg,#4ECDC4,#2C3E6B)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, fontWeight: 700, color: '#fff', fontFamily: "'Syne', sans-serif", flexShrink: 0 },
  ownerFavRow:    { display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8, fontSize: 14 },
  heartSideBtn:   { width: '100%', padding: '10px', borderRadius: 10, border: '1px solid', cursor: 'pointer', fontSize: 15, fontFamily: "'Syne', sans-serif", fontWeight: 600, transition: 'all 0.15s' },
